                      ...
                      children: [
                        ListTile(
                          leading: ConstrainedBox(
                            ...
                            child: Image.asset('images/pessoa4.jpg', fit: BoxFit.contain),
                          ),
                          title: Text('Pietro Tomás Raimundo Dias'),
                          subtitle: Text('Caxias do Sul / RS                                        (73) 3548-9812'),
                          isThreeLine: true,
                        ),
                      ],
                    ),
                      ...
                      children: [
                        ListTile(
                          leading: ConstrainedBox(
                            ...
                            child: Image.asset('images/pessoa5.jpg', fit: BoxFit.contain),
                          ),
                          title: Text('Caio Manuel Nelson Lima'),
                          subtitle: Text('Planaltina / GO                                        (47) 99731-6377'),
                          isThreeLine: true,
                        ),
                      ],
                    ),
                      ...
                      children: [
                        ListTile(
                          leading: ConstrainedBox(
                            ...
                            child: Image.asset('images/pessoa6.jpg', fit: BoxFit.contain),
                          ),
                          title: Text('Daniel Noah Castro'),
                          subtitle: Text('Rio Branco / AC                                        (73) 99721-7905'),
                          isThreeLine: true,
                        ),
                      ],
                    ),
